import whatsapp from "/assets/faq-icons/whatsapp.png";
import email from "/assets/faq-icons/email.svg";
import phone from "/assets/faq-icons/phone.svg";
import background from "/assets/faq-banner.jpg";
...
export const FaqHero = () => {
    ...
    return(
        <section className="w-full relative h-[550px] py-[100px] px-10 flex flex-col lg:flex-row justify-between items-center gap-10">
            <img className="w-screen h-full absolute z-[1] top-0 left-0 object-cover" src={background} alt="Background" />
